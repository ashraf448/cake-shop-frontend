...
//   useEffect(() => {
//     setPage(1);
//   }, [search, minPrice, maxPrice, sort, category]);
...
//     return data;
//   }, [allProducts, search, minPrice, maxPrice, sort, normalizedCategory]);
...
//   {/* يظهر فقط لو فيه category متفعّل */}
//   {category && (
//     <button
